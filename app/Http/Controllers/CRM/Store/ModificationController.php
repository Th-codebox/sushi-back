...
use App\Http\Requests\CRM\Modification\CreateModification;
use App\Http\Requests\CRM\Modification\UpdateModification;
use App\Http\Resources\CRM\ModificationResource;
use App\Services\CRM\Store\ModificationService;
use Illuminate\Http\Request;

class ModificationController extends BaseCRMController
{
    public function __construct(ModificationService $service)
    {
        parent::__construct($service,CreateModification::class,UpdateModification::class,ModificationResource::class);
    }
