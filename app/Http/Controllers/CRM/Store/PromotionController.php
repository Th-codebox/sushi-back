...
use App\Http\Requests\CRM\Promotion\CreatePromotion;
use App\Http\Requests\CRM\Promotion\UpdatePromotion;
use App\Http\Resources\CRM\PromotionResource;
use App\Services\CRM\Store\PromotionService;
use Illuminate\Http\Request;

class PromotionController extends BaseCRMController
{
    public function __construct(PromotionService $service)
    {
        parent::__construct($service,CreatePromotion::class,UpdatePromotion::class,PromotionResource::class);
    }
